...
internal static class TooltipPatches
{
    ...
    private class PriceTooltipPatch : ModulePatch
    {
        ...
        [PatchPrefix]
        public static void Prefix(PriceTooltip __instance)
        {
            ...
            if (DebugText == null)
            {
                DebugText = UnityEngine.Object.Instantiate(__instance._price, __instance._price.transform.parent.parent, false);
